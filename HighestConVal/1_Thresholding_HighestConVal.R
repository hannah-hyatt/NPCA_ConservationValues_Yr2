...
conservationvalue.raster<-raster::raster("S:/Projects/NPCA/_Year2/Data/Intermediate/ConservationValue_MaskedStudyAreas/ConservationValue_GreaterYellowstone.tif")
